...
We can start off with our assummptions for SLR, which are \epslion \overset{i.i.d}{\sim} N(0, \sigma^2).
...
random variable such that $Y \sim N(\beta_0 + \beta_1X_i, \sigma^2)$
